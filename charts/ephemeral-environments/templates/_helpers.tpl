...
*/}}
{{- define "ephemeral-environments.fullname" -}}
...
app.kubernetes.io/name: {{ include "ephemeral-environments.name" . }}
...
{{- default (include "ephemeral-environments.fullname" .) .Values.serviceAccount.name }}
{{- else }}
